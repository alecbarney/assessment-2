...
/* 
    ...
    Look it up on MDN if you're not sure how to use 1
    it. 
...
const canWeDeliverTwo = (zipcode) =>{
    ...
    } return ('Sorry we cant deliver to your address')
}



console.log(canWeDeliverTwo(85276))
